...
<title><c:out value="${completeTitle}" /> 完了</title>
...
<table class="basic">
	...
	<tr>
		<td class="basic-middle">
			...
			<table class="done">
				<tr>
					<th class="subject"><c:out value="${completeTitle}" /> 完了</th>
				</tr>
				<tr><td><hr></td></tr>
				<tr>
					<td><c:out value="${completeMessage}" /></td>
				</tr>
				<tr>
					<td><hr></td>
				</tr>
				<tr>
					<td>
						<table>
							<tr>
							<td class="bottom-link"><a href="<c:out value="${completeLink1}" />"><c:out value="${completeLink1Title}" /></a></td>
							<td class="bottom-link"><a href="<c:out value="${completeLink2}" />"><c:out value="${completeLink2Title}" /></a></td>
							</tr>
						</table>
					</td>
				</tr>
