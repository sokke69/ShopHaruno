 ...
 */
@WebServlet("/listProductOnlyView")
public class ListProductOnlyViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			request.getRequestDispatcher("/WEB-INF/view/listProductOnlyView.jsp").forward(request, response);
		} catch (Exception e) {
